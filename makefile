...
photo_client: photo_client.o util.o client_network_layer.o client_data_link_layer.o physical_layer.o client_physical_layer_error.o
	$(CC) $(CFLAGS) -o team_3_photo_client photo_client.o util.o client_network_layer.o client_data_link_layer.o physical_layer.o client_physical_layer_error.o
...
photo_server: photo_server.o util.o server_network_layer.o server_data_link_layer.o physical_layer.o server_physical_layer_error.o
	$(CC) $(CFLAGS) -lpthread -o team_3_photo_server photo_server.o util.o server_network_layer.o server_data_link_layer.o physical_layer.o server_physical_layer_error.o
