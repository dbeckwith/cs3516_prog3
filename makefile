...
photo_client: photo_client.o util.o client_network_layer.o client_data_link_layer.o client_physical_layer.o client_physical_layer_error.o
...
client_physical_layer.o: client_physical_layer.c physical_layer.h
	$(CC) $(CFLAGS) -c client_physical_layer.c

client_physical_layer_error.o: client_physical_layer_error.c physical_layer.h
	$(CC) $(CFLAGS) -c client_physical_layer_error.c

photo_server: photo_server.o util.o server_network_layer.o server_data_link_layer.o server_physical_layer.o server_physical_layer_error.o
	$(CC) $(CFLAGS) -o team_3_photo_server photo_server.o util.o network_layer.o data_link_layer.o physical_layer.o
...
server_physical_layer.o: server_physical_layer.c physical_layer.h
	$(CC) $(CFLAGS) -c server_physical_layer.c
